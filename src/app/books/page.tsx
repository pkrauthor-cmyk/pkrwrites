      ...
      <section style={{ paddingTop: '160px', paddingBottom: '8rem', background: 'var(--bg-dark)', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative' }}>
          <div className="section-title fade-in" style={{ textAlign: 'left', marginBottom: '6rem' }}>
            <h3 style={{ textTransform: 'uppercase', letterSpacing: '0.3rem', color: 'var(--primary)', marginBottom: '1.5rem', fontSize: '0.75rem', fontWeight: 700 }}>Complete library</h3>
            <h1 style={{ fontSize: 'clamp(2.5rem, 7vw, 5rem)', marginBottom: '2rem', fontWeight: 800 }}>The Collection</h1>
          ...
          {books.length > 0 ? (
            ...
            <div className="fade-in" style={{ 
              ...
              <div style={{ fontSize: '3.5rem', opacity: 0.1, filter: 'grayscale(100%) brightness(200%)' }}>📚</div>
              <h3 style={{ fontSize: '1.8rem', color: 'white', letterSpacing: '0.1em', fontWeight: 700 }}>Bibliographic Update in Progress</h3>
              <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', maxWidth: '500px', lineHeight: '1.8' }}>
                We're currently syncing the latest titles from the Amazon Author Page. Explore the full library shortly.
              </p>
