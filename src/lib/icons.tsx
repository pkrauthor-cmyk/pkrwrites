...
export const BrandIcons: Record<string, (props: any) => React.ReactNode> = {
  Facebook: (props) => (
  ...
  Amazon: (props) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M11.66 14.54a3.1 3.1 0 0 0-2 1c-.3.3-.41.69-.32 1.1s.41.81.81.9C11 17.7 12.3 17 13 15.8c.4-.7.6-1.5.5-2.3 0-1.2-.5-2.2-1.3-2.9-.8-.7-1.9-1.1-3.2-1.1-1.3 0-2.4.4-3.2 1.1-.8.7-1.3 1.7-1.3 2.9 0 1.2.5 2.2 1.3 2.9.8.7 1.9 1.1 3.2 1.1 1.3 0 2.4-.4 3.2-1.1.2-.2.3-.5.3-.8" />
      <path d="M3 18c1.5 1.5 3.5 2 5.5 2 3.5 0 6.5-1.5 8.5-4 1-1.2 1.5-2.5 1.5-4 0-4.5-3.5-8-8-8-4.5 0-8 3.5-8 8 0 .5 0 1 .1 1.5" />
    </svg>
  ),
};